  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-5xl px-3">
          KrabbyPatty<span className="font-bold">Delights</span>
        </h1>
      ...
      >
        ...
        <h2 className="text-2xl p-4">
          CrabbyPatty<span className="font-bold">Delights</span>
        </h2>
        <nav>
